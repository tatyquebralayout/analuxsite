  ...
  return (
    <section id="services" className="py-16 bg-neutral-surface" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        >
          {/* Daycare - Usando o ícone personalizado fornecido pelo cliente */}
          <motion.div 
          ...
          >
            <div className="p-6">
              ...
              <p className="body1 text-gray-600 mb-4">{t.services.daycare.description}</p>
              <motion.a 
                href="#" 
          ...
          >
            <div className="p-6">
              ...
              <p className="body1 text-gray-600 mb-4">{t.services.hotel.description}</p>
              <motion.a 
                href="#" 
                className="text-primary font-medium hover:text-primary-dark transition-colors"
                whileHover={{ x: 5 }}
          ...
          >
            <div className="p-6">
              ...
              <p className="body1 text-gray-600 mb-4">{t.services.training.description}</p>
              <motion.a 
                href="#" 
                className="text-primary font-medium hover:text-primary-dark transition-colors"
                whileHover={{ x: 5 }}
          ...
          >
            <div className="p-6">
              ...
              <p className="body1 text-gray-600 mb-4">{t.services.taxi.description}</p>
              <motion.a 
                href="#" 
                className="text-primary font-medium hover:text-primary-dark transition-colors"
                whileHover={{ x: 5 }}
          ...
          >
            <div className="p-6">
              ...
              <h3 className="headline6">{t.services.grooming.title}</h3>
              <p className="body1 text-gray-600 mb-4">{t.services.grooming.description}</p>
              <motion.a 
                href="#" 
                className="text-primary font-medium hover:text-primary-dark transition-colors"
                whileHover={{ x: 5 }}
