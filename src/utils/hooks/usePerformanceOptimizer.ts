...
/**
 * Interface de opções para o otimizador de performance
 */
interface PerformanceOptions {
  disableAnimationsOnLowEnd?: boolean;  // Desativa animações em dispositivos de baixo desempenho
  reducedMotionPreference?: boolean;    // Respeita preferência de movimento reduzido
  cookieKey?: string;                   // Chave para armazenar preferência em cookie
}
