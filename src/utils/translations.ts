export const translations = {
  ...
  de: {
    ...
    advantages: {
      title: '[pt: Por que a AmanluxDog é a escolha certa para o seu cão?]',
      stories: {
        title: '[pt: Histórias Felizes]',
        description: '[pt: Cada cliente é uma nova família que conquistamos.]',
      },
      years: {
        title: '[pt: Anos de Paixão por Cães]',
        description: '[pt: Experiência que você pode confiar.]',
      },
      space: {
        title: '[pt: de Espaço para Alegria]',
        description: '[pt: Um playground seguro para todas as raças.]',
      },
      attention: {
        title: '[pt: Atenção]',
        description: '[pt: Sempre cuidando, sempre amando.]',
      },
    },
    services: {
      title: 'Angebot',
      learnMore: '[pt: Saiba Mais]',
      daycare: {
      ...
      grooming: {
        title: '[pt: Parceria DogAffair]',
        description: '[pt: Banho, tosa e cuidados extras para manter seu cão impecável.]',
      },
    },
    about: {
      title: 'Über uns',
      ...
      button: '[pt: Conheça Nosso Espaço]',
    },
    team: {
      title: 'Unsere TEAM',
      button: '[pt: Conheça Nossa Equipe]',
      member1: {
        name: 'Daniel León',
    ...
    testimonials: {
      title: '[pt: O que os donos de cães estão dizendo sobre nós]',
      badge: '[pt: 98% dos clientes recomendam a AmanluxDog!]',
      items: [
        {
          text: '[pt: Minha Luna ama a AmanluxDog! Ela volta para casa cansada e feliz. Recomendo muito!]',
          name: 'Maria',
          pet: '[pt: dona da Luna 🐕]',
        },
        {
          text: '[pt: O serviço de táxi foi uma mão na roda. Meu Max adora lá!]',
          name: 'João',
          pet: '[pt: dono do Max 🐶]',
        },
        {
          text: '[pt: Minha cachorrinha é muito tímida, mas a equipe da AmanluxDog soube lidar com ela perfeitamente!]',
          name: 'Carla',
          pet: '[pt: dona da Mel 🐕]',
        },
      ],
    ...
    gallery: {
      sectionTitle: '[DE: Enjoy Our Galery]',
      title: '[pt: Momentos felizes que contam histórias]',
      viewImage: '[pt: Ver imagem]',
      viewAll: '[pt: Ver Toda a Galeria]',
      instagram: '[pt: Siga-nos no Instagram]',
    },
    faq: {
      title: '[pt: Respostas rápidas para suas dúvidas]',
      viewAll: '[pt: Veja Todas as Perguntas]',
      items: [
        {
          question: '[pt: Como funciona o serviço de táxi?]',
          answer:
            '[pt: Oferecemos transporte seguro e confortável dentro da zona de atuação. Basta agendar com pelo menos 24h de antecedência.]',
        },
        {
          question: '[pt: O que meu cão precisa levar?]',
          answer:
            '[pt: Apenas coleira, guia e documentos de vacinação. Recomendamos também trazer o brinquedo favorito para maior conforto.]',
        },
        {
          question: '[pt: Meu cão precisa ser sociável?]',
          answer:
            '[pt: Não necessarily. Avaliamos cada caso individualmente e temos espaços separados para cães que precisam de adaptação gradual.]',
        },
      ],
    },
    contact: {
      ...
      message: 'Nachricht *',
      submit: 'Jetzt Senden',
      promise: '[pt: Prometemos responder em até 24 horas.]',
      or: '[pt: Ou ligue para nós:]',
      successMessage: '[pt: Mensagem enviada com sucesso! Entraremos em contato em breve.]',
    },
    location: {
      title: '[pt: Estamos aqui para receber você e seu cão!]',
      city: 'Zürich',
      phone: '+41 76 575 09 77',
      email: 'info@amanlux.com',
      hours: 'Mon - Fre / 7:00 AM - 6:30 PM',
      address: '[pt: Endereço]',
      taxiArea: '[pt: Área de atuação do táxi]',
      taxiDescription: '[pt: Atendemos toda a região central e zonas sul e oeste de São Paulo.]',
      parking: '[pt: Estacionamento]',
      parkingDescription: '[pt: Estacionamento gratuito para clientes por até 30 minutos.]',
    },
    footer: {
      weekdays: '[pt: Segunda a Sexta]',
      weekends: '[pt: Sábados e Domingos]',
      quickLinks: '[pt: Links Rápidos]',
      followUs: '[pt: Redes Sociais]',
      privacy: '[pt: Política de Privacidade]',
      terms: '[pt: Termos de Uso]',
      newsletter: '[pt: Newsletter]',
      newsletterText: '[pt: Receba dicas exclusivas e novidades sobre cuidados para cães!]',
      emailPlaceholder: '[pt: Seu e-mail]',
      subscribe: '[pt: Inscrever-se]',
      subscribeSuccess: '[pt: Inscrição realizada com sucesso!]',
      rights: '[pt: Todos os direitos reservados.]',
    },
    hundebetreuungPage: {
      intro: {
